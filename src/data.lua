...
Crutch.filter = {
    [ 73741] = function(hitValue) return hitValue >= 1900 and Crutch.GetUnitTagsSquaredDistance("player", targetUnitTag) <= 900 end, -- Threshing Wings (only get the initial cast, not the weird other parts that are cast on everyone)
    [ 74488] = function(hitValue, targetUnitTag) return Crutch.GetUnitTagsSquaredDistance("player", targetUnitTag) <= 900 end, -- Unstable Void (Rakkhat)
    [ 74384] = function(hitValue, targetUnitTag) return Crutch.GetUnitTagsSquaredDistance("player", targetUnitTag) <= 900 end, -- Dark Barrage (initial)
    [ 74385] = function(hitValue, targetUnitTag) return Crutch.GetUnitTagsSquaredDistance("player", targetUnitTag) <= 900 end, -- Dark Barrage (start)
