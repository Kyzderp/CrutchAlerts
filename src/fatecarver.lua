...
local fatecarverIds = {
    [185805] = true, -- function() return not Crutch.savedOptions.general.beginHideArcanist end, -- Fatecarver (cost mag)
    [193331] = true, -- function() return not Crutch.savedOptions.general.beginHideArcanist end, -- Fatecarver (cost stam)
    [183122] = true, -- function() return not Crutch.savedOptions.general.beginHideArcanist end, -- Exhausting Fatecarver (cost mag)
    [193397] = true, -- function() return not Crutch.savedOptions.general.beginHideArcanist end, -- Exhausting Fatecarver (cost stam)
    [186366] = true, -- function() return not Crutch.savedOptions.general.beginHideArcanist end, -- Pragmatic Fatecarver (cost mag)
    [193398] = true, -- function() return not Crutch.savedOptions.general.beginHideArcanist end, -- Pragmatic Fatecarver (cost stam)
